...
//  poketmon[i]=포켓몬 905 poketmon[0]=이름 중 첫번째 글자
// poketmon[i][0]:포켓몬 905개 중 첫번재 성
// coumt++ 위에 count는 0이라고 정해놨기때문에 +1+1
//i= index , i<pokrtmon.length:길이만큼의 반복
// 만약에 "이씨" === poketmon[i][0]에 있다면 console.log로 찍을테니 나타내줘
//count는 숫자를 세고 ++
for(let i = 0; i < _pokemon.length; i++){
 if(fromInputData === _pokemon[i][0]){
  count++;
  // console.log(count);
